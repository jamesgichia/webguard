...
| Segment | Global Size | WebGuard Addressable Subset |
|---|---|---|
| Developers worldwide | ~28 million | ~2 million active security-conscious developers |
| SMBs with web presence | ~400 million | ~5 million with real security awareness and budget |
| Security consultants | ~500,000 globally | ~50,000 doing web security assessments |
| IT managers/CTOs | ~10 million | ~1 million responsible for web application security |
